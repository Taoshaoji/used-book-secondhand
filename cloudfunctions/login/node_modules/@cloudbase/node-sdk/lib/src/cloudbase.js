...
class CloudBase {
    ...
    init(config = {}) {
        let { debug, secretId, secretKey, sessionToken, env, proxy, timeout, serviceUrl, version, headers = {}, credentials, isHttp, throwOnCode, forever, timingsMeasurerOptions, retries } = config;
